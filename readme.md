...
The *235Web/.env* file contains variable settings. They are set with appropriate values.
...
Testing requires that file *235Web/tests/conftest.py* be edited to set the value of `TEST_DATA_PATH`. You should set this to the absolute path of the *235Web/tests/data* directory. 

E.g. 

`TEST_DATA_PATH = os.path.join('C:', os.sep, 'Users', 'cool_', 'PycharmProjects', '235Web', 'tests', 'data')`

assigns TEST_DATA_PATH with the following value (the use of os.path.join and os.sep ensures use of the correct platform path separator):

`C:\Users\cool_\PycharmProjects\235Web\tests`
